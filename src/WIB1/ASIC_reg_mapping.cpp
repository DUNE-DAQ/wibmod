...
void
ASIC_reg_mapping::set_board(const FE_ASIC_reg_mapping& fe_map, const ADC_ASIC_reg_mapping& adc_map)
{
...
std::vector<uint32_t>
ASIC_reg_mapping::get_regs() const
{
  return REGS;
}

void
ASIC_reg_mapping::print() const
{
