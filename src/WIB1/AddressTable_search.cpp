...
AddressTable::GetNames()
{
  std::vector<std::string> names;
  for (std::map<std::string, Item*>::iterator it = nameItemMap.begin(); it != nameItemMap.end(); it++) {
...
std::vector<std::string>
AddressTable::GetNames(std::string const& regex)
{
  std::vector<std::string> names;
  // Fix regex
  std::string rx = regex;
...
std::vector<std::string>
AddressTable::GetAddresses(uint16_t lower, uint16_t upper)
{
  std::vector<std::string> names;
...
std::vector<std::string>
AddressTable::GetTables(std::string const& regex)
{
...
AddressTable::GetTagged(std::string const& tag)
{
